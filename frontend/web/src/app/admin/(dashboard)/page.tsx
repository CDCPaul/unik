...
export default function AdminDashboardPage() {
  return (
    <div className="space-y-8">
      ...
      >
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center justify-between">
            ...
            <a href="/admin/registrations" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
              View all →
            </a>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-slate-200">
              {recentRegistrations.map((reg) => (
                <tr key={reg.id} className="hover:bg-slate-50">
                  <td className="admin-table-cell font-medium">{reg.name}</td>
                  <td className="admin-table-cell text-slate-500">{reg.email}</td>
                  <td className="admin-table-cell text-slate-500">{reg.date}</td>
      ...
      >
        <a href="/admin/navigation" className="admin-card p-6 hover:shadow-md transition-shadow">
        ...
        <a href="/admin/content" className="admin-card p-6 hover:shadow-md transition-shadow">
        ...
        <a href="/admin/theme" className="admin-card p-6 hover:shadow-md transition-shadow">

...
import { Upload, Trash2, Loader2, Image as ImageIcon, Filter } from 'lucide-react';
import { 
  getGalleryImages, 
  addGalleryImage, 
  updateGalleryImage,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage tour photos and videos</p>
        </div>
                ...
                {editingCaption?.id === image.id ? (
                  <div className="flex gap-1">
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') handleUpdateCaption(image.id, editingCaption.caption);
